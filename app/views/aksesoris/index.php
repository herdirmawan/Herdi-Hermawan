    ...
    <?php foreach ($data['aksesoris'] as $key  ) { ?>
      <ul class="list-group">
        <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <a href="<?= BASEURL; ?>/aksesoris/editAksesoris/<?=$key['id']; ?>" class="badge badge-warning">Ubah</a>
          <a href="<?= BASEURL; ?>/aksesoris/hapusAksesoris/<?=$key['id']; ?>" class="badge badge-danger" onclick = 'return confirm("Yakin dihapus?")'>Hapus</a>
        </li>
      </ul>
    <?php } ?>
  </div>
